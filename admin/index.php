...
<head>
    <title>Teknologi Massa Kini</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Teknologi Massa Kini</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">rizal</div>
                    <div class="email">Anda Login Sebagai,..</div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">Toko Moza - Rijal Arfani</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.7
                </div>
